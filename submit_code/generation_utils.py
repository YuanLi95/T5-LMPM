...
class GenerationMixin:
    ...
    def _prepare_encoder_decoder_kwargs_for_generation(
        ...
        Z_hidden, encoder_outputs = self.forward(return_memory=True, **encoder_kwargs, )
        # print(Z_hidden)
        # print(encoder_outputs)
        # print("1111111")
        # exit()
        model_kwargs["encoder_outputs"]: ModelOutput = encoder_outputs
        model_kwargs["Z_hidden"]: ModelOutput = Z_hidden
    ...
    def generate(
        ...
        **model_kwargs,
        ...
        if is_greedy_gen_mode:
            ...
            # print("choose the is_sample_gen_mode")
            # exit()
        ...
        while True:
            ...
            outputs = self(
                **model_inputs,
                ...
                output_attentions=output_attentions,
                output_hidden_states=output_hidden_states,
                Z_hidden = model_kwargs["Z_hidden"]
            )
            # print(self)
            # print("---*"*20)
            # print(outputs)
